...
- you can [CRUD](http://en.wikipedia.org/wiki/Create,_read,_update_and_delete) your `ci plan` directly from PowerShell either interactively or via script and as you do, a snapshot of it is saved in a `CIPlanArchive.json` file.
